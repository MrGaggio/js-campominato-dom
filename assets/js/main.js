...
/*
const bombsElements = document.getElementsByClassName('bombs')
const bombsList = []
for (let index = 0; index < bombsElements.length; index++) {
  const bomb = Number(bombsElements[index].innerText);
  bombsList.push(bomb)
}
